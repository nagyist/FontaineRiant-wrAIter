...
pip install whisper-mic==1.4.2 sentencepiece inquirerpy coqui-tts pygame pysbd diffusers accelerate gguf
pip install transformers torch==2.5.1 torchvision==0.20.1 torchaudio==2.5.1 --index-url https://download.pytorch.org/whl/rocm6.2
# quantization
